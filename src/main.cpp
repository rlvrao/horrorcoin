...
uint256 hashGenesisBlock("0x976c70e60dfca49f0849f665958f64ea8e19cfdadae370e60b9a1e9236e9204d");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf832147555efc259587872a619323a818b5df1bc70fb11354c8da414c722e86c");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "July 06, 2015, Rajahmundry, Andhra Pradesh Tirumala Venkateswara Temple Replica to be Erected in Rajahmundry";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1436173321; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2563933;

        if (fTestNet)
        {
            block.nTime    = 1436173321;
            block.nNonce   = 586268;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3f64a8d0725dffaac4ba873f9522ff3376b73118d7430747d9014e7683fbd740"));
